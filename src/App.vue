    ...
    async fetchData() {
      ...
      try {
        ...
        const wResponse = await fetch(
          `https://api.weatherapi.com/v1/forecast.json?key=e8fabfe4b207420891f15128251901&q=${this.lat},${this.lon}`
        );
        ...
        const forecast = await fetch(
          `https://api.weatherapi.com/v1/forecast.json?key=e8fabfe4b207420891f15128251901&q=${this.lat},${this.lon}&days=8`
        );
